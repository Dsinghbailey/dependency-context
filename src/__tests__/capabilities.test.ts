import { analyzeAndIndexDependencies, AnalyzeParamsSchema } from '../capabilities/analyze';
import { searchDependencyDocs, SearchParamsSchema } from '../capabilities/search';
...
describe('Capabilities Tests', () => {
  ...
  describe('analyzeAndIndexDependencies', () => {
    ...
    test('should process dependencies successfully', async () => {
      ...
      // Setup mocks
      (parsers.parseDependencies as jest.Mock).mockResolvedValue(mockDependencies);
      (repositories.findGitHubRepository as jest.Mock).mockResolvedValue(mockRepo);
  ...
  describe('searchDependencyDocs', () => {
    test('should return search results', async () => {
      ...
      const mockResults = [
        {
          text_chunk: 'Express is a minimal and flexible Node.js web application framework',
          source_repository: 'https://github.com/expressjs/express',
          source_file: '/README.md',
          similarity_score: 0.92
        },
        {
          text_chunk: 'Express provides a robust set of features for web applications',
          source_repository: 'https://github.com/expressjs/express',
      ...
      // Setup mocks
      (vectorstore.searchVectorStore as jest.Mock).mockResolvedValue(mockResults);
